...
*/	
	...
	$IPdata = ipInfo(get_public_ip()); // display IP address get_public_ip()
...
*/	
	...
	$sql_ss		= "SELECT * FROM admin_graphic_visits_month WHERE sessionIP='$session'";
	$result_ss	= mysqli_query($con, $sql_ss);
	$count		= mysqli_num_rows($result_ss); 
